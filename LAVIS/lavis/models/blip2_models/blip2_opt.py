...
class Blip2OPT(Blip2Base):
    ...
    def __init__(
        ...
        self.visual_encoder, self.ln_vision = self.init_vision_encoder(
            vit_model, img_size, drop_path_rate, use_grad_checkpoint, vit_precision, vision_encoder_weights
        )
    ...
    def from_config(cls, cfg):
        ...
        vision_encoder_weights = cfg.get("vision_encoder_weights")
